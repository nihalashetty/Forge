...
- 👁️ **Observable by default.** Every run is a span waterfall with tokens, latency, and cost down to fractions of a cent.
...
> ▶️ **[Watch the demo](docs/media/forge-assistant-demo.mp4)** - the in-product **Forge Assistant** builds and runs a workflow end to end. *(If the player doesn't load inline, click the link to play.)*
...
### 🛠️ Tool Builder with Response Projection
...
- 🕸️ **Visual workflow canvas** (React Flow) - routers, loops, parallel fan-out/join, transforms, and reusable subworkflows with typed, validated connections.
...
<div align="center">
<sub>Built with ⚒️ on open source.</sub>
</div>
